...
public class FeriaBean implements Serializable {
	...
	private List<Funcionario> funcionarios = new ArrayList<Funcionario>(); // responsável por exibir ou salvar um
																			// funcionário que esta em outra tabela.
	...
	public void novo() {
		...
		/*
		 * Essas duas definições é necessária para quando abrir o formulário carregar os
	...
	/**
	 * Listar todos os dados da tabela feriado incluindo de outras tabelas que
	...
	public void editar(ActionEvent evento) {
		try {
			...
			/*
			 * Como na hora de editar se for o caso tem que alterar o funcionário. será
			 * necessário mostrar através destas duas linhas abaixo:
			 * 
			 */
			FuncionarioDAO funcionarioDAO = new FuncionarioDAO();
			funcionarios = funcionarioDAO.listar();
